...
Drop view if exists PopularInstagramInfluencers;
Drop view if exists FollowerGrowthRate;
Drop view if exists EngagementRate;
...
-- view to get PopularInstagramInfluencers

CREATE VIEW PopularInstagramInfluencers AS
...
-- view to determine FollowerGrowthRate

CREATE VIEW FollowerGrowthRate  AS
SELECT u.UserID,
  u.UserName,
  u.FollowersCount as followercount

FROM Users u
JOIN Followers f ON f.UserID = u.UserID
WHERE f.FollowedDate >= DATEADD(year, -1, GETDATE())
GROUP BY u.UserID,u.UserName, u.FollowersCount;

 
-- view to determine EngagementRate

CREATE VIEW EngagementRate  AS
SELECT u.UserID,
  u.UserName,
  SUM(m.InteractionCount) as Interactioncount

FROM Users u
JOIN Media m ON m.UserID = u.UserID
JOIN Interactions i ON i.UserID=u.UserID
WHERE i.Date >= DATEADD(YEAR , -1, GETDATE())
...
BEGIN    
  ...
  DECLARE cur_inserted CURSOR FOR SELECT FollowerID FROM inserted;
  
  OPEN cur_inserted;
  FETCH NEXT FROM cur_inserted INTO @FollowerID;
  
  WHILE @@FETCH_STATUS = 0
  BEGIN
    SELECT @UserID = UserID FROM Followers WHERE FollowerID = @FollowerID;
    UPDATE Users SET FollowersCount = FollowersCount + 1 WHERE UserID = @UserID;
    UPDATE Users SET FollowingCount = FollowingCount + 1 WHERE UserID = @FollowerID;
    FETCH NEXT FROM cur_inserted INTO @FollowerID;
  END
...
(1, 4, '2022-01-01 12:00:00'), 
(2, 4, '2022-02-01 12:00:00'), 
(3, 4, '2023-03-03 12:00:00'), 
(5, 4, '2023-03-03 12:00:00'), 
(6, 4, '2023-04-05 12:00:00'), 
(7, 4, '2023-04-06 12:00:00'), 
(8, 4, '2023-07-07 12:00:00'), 
(1, 13, '2019-07-08 12:00:00'), 
(2, 13, '2019-01-09 12:00:00'), 
(3, 13, '2021-02-10 12:00:00'), 
(4, 13, '2022-04-06 12:00:00'), 
(5, 13, '2022-07-07 12:00:00'), 
(6, 13, '2022-07-08 12:00:00'), 
(7, 13, '2022-08-09 12:00:00'), 
(8, 13, '2022-02-10 12:00:00'), 
(9, 13, '2022-07-08 12:00:00'), 
(10, 13, '2022-01-09 12:00:00'), 
(11, 13, '2022-02-10 12:00:00'),
(14, 13, '2021-01-09 12:00:00'), 
(1, 11, '2019-02-10 12:00:00'),
(2, 11, '2022-01-09 12:00:00'), 
(3, 11, '2022-02-10 12:00:00'),
(4, 11, '2022-01-09 12:00:00'), 
(5, 11, '2022-02-10 12:00:00'),
(6, 11, '2022-01-09 12:00:00'), 
(7, 11, '2022-02-10 12:00:00'),
(1, 10, '2022-01-01 12:00:00'), 
(2, 10, '2022-02-01 12:00:00'), 
(3, 10, '2023-03-03 12:00:00'), 
(4, 10, '2023-03-03 12:00:00'), 
(5, 10, '2023-04-05 12:00:00'), 
(6, 10, '2023-04-06 12:00:00'), 
(1, 8, '2023-07-07 12:00:00'), 
(2, 8, '2019-07-08 12:00:00'), 
(3, 8, '2019-01-09 12:00:00'), 
(4, 8, '2021-02-10 12:00:00'), 
(5, 8, '2022-04-06 12:00:00'), 
(6, 8, '2022-07-07 12:00:00'), 
(20, 8, '2022-07-08 12:00:00'), 
(9, 8, '2022-08-09 12:00:00'), 
(8, 11, '2022-02-10 12:00:00'), 
(9, 11, '2022-07-08 12:00:00'), 
(20, 11, '2022-01-09 12:00:00'), 
(12, 11, '2022-02-10 12:00:00'),
(13, 11, '2021-01-09 12:00:00'), 
(14, 11, '2019-02-10 12:00:00'),
(15, 11, '2022-01-09 12:00:00'), 
(16, 11, '2022-02-10 12:00:00'),
(17, 11, '2022-01-09 12:00:00'), 
(18,11, '2022-02-10 12:00:00'),
(19, 11, '2022-01-09 12:00:00'), 
(20, 11, '2022-02-10 12:00:00');
